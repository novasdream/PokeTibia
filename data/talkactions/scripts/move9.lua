...
setConditionFormula(sleepcondition, -0.9, 0, -0.9, 0)
 ...
 tfn = createCombatArea(pokeSpell.tfn)
 tfs = createCombatArea(pokeSpell.tfs)
 tfe = createCombatArea(pokeSpell.tfe)
 tfw = createCombatArea(pokeSpell.tfw)
 ...
 mstorm1 = createCombatArea(pokeSpell.mstorm1)
 mstorm2 = createCombatArea(pokeSpell.mstorm2)
 mstorm3 = createCombatArea(pokeSpell.mstorm3)
 mstorm4 = createCombatArea(pokeSpell.mstorm4)
 mstorm5 = createCombatArea(pokeSpell.mstorm5)
