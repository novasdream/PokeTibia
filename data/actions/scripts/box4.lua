...
elseif r1 == 29 then
doPlayerSendTextMessage(cid,22,"Você ganhou um Dark Abra.")
local health = 6000 -- Health do poke
local maxhealth = 6000 -- Maximo de health do poke
local description = "Contains a Dark Abra."
local poke1 = "This is Dark Abra's pokeball. HP = ["..health.."/"..maxhealth.."]"
item = doCreateItemEx(2219)
doItemSetAttribute(item, "poke", poke1)
doItemSetAttribute(item, "nome", "Dark Abra")
doItemSetAttribute(item, "description", description)
doPlayerAddItemEx(cid, item, true)
doTransformItem(item, 2222)
doSendMagicEffect(getCreaturePosition(cid), 28)
...
elseif r1 == 36 then
doPlayerSendTextMessage(cid,22,"Você ganhou um Heracross.")
local health = 6000 -- Health do poke
local maxhealth = 6000 -- Maximo de health do poke
local description = "Contains a Heracross."
local poke1 = "This is Heracross's pokeball. HP = ["..health.."/"..maxhealth.."]"
item = doCreateItemEx(2219)
doItemSetAttribute(item, "poke", poke1)
doItemSetAttribute(item, "nome", "Heracross")
doItemSetAttribute(item, "description", description)
doPlayerAddItemEx(cid, item, true)
doTransformItem(item, 2222)
doSendMagicEffect(getCreaturePosition(cid), 28)
...
elseif r1 == 45 then
doPlayerSendTextMessage(cid,22,"Você ganhou uma Piloswine.")
local health = 6000 -- Health do poke
local maxhealth = 6000 -- Maximo de health do poke
...
elseif r1 == 47 then
doPlayerSendTextMessage(cid,22,"Você ganhou um Skarmory.")
local health = 6000 -- Health do poke
local maxhealth = 6000 -- Maximo de health do poke
local description = "Contains a Skarmory."
local poke1 = "This is Skarmory's pokeball. HP = ["..health.."/"..maxhealth.."]"
item = doCreateItemEx(2219)
doItemSetAttribute(item, "poke", poke1)
doItemSetAttribute(item, "nome", "Skarmory")
doItemSetAttribute(item, "description", description)
doPlayerAddItemEx(cid, item, true)
doTransformItem(item, 2222)
doSendMagicEffect(getCreaturePosition(cid), 28)
...
elseif r1 == 51 then
doPlayerSendTextMessage(cid,22,"Você ganhou um Sudowoodo.")
local health = 6000 -- Health do poke
local maxhealth = 6000 -- Maximo de health do poke
local description = "Contains a Sudowoodo."
local poke1 = "This is Sudowoodo's pokeball. HP = ["..health.."/"..maxhealth.."]"
item = doCreateItemEx(2219)
doItemSetAttribute(item, "poke", poke1)
doItemSetAttribute(item, "nome", "Sudowoodo")
doItemSetAttribute(item, "description", description)
doPlayerAddItemEx(cid, item, true)
doTransformItem(item, 2222)
doSendMagicEffect(getCreaturePosition(cid), 28)
